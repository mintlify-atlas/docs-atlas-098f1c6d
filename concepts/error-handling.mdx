...
**Request:**
```bash
curl "https://api.terraquake.com/earthquakes/recent?page=0&limit=-5"
```
...
**Request:**
```bash
curl "https://api.terraquake.com/earthquakes/date-range?startdate=invalid&enddate=2026-03-03"
```
...
**Request:**
```bash
curl "https://api.terraquake.com/earthquakes/nonexistent-endpoint"
```
...
async function getEarthquakes() {
  try {
    const response = await fetch(
      'https://api.terraquake.com/earthquakes/recent?limit=50'
    );
...
def get_earthquakes(max_retries=3):
    url = 'https://api.terraquake.com/earthquakes/recent'
    params = {'limit': 50}
...
func getEarthquakes(maxRetries int) (map[string]interface{}, error) {
    url := "https://api.terraquake.com/earthquakes/recent?limit=50"
