...
```bash Request
curl "https://api.terraquake.com/earthquakes/recent?limit=50"
```
...
```bash Request
curl "https://api.terraquake.com/earthquakes/magnitude?mag=5.0"
```
...
curl "https://api.terraquake.com/earthquakes/recent?sort=-magnitude"

# Sort by time (ascending)
curl "https://api.terraquake.com/earthquakes/recent?sort=time"

# Multiple sort fields
curl "https://api.terraquake.com/earthquakes/recent?sort=-magnitude,time"
```
...
curl "https://api.terraquake.com/earthquakes/recent?fields=time,magnitude,place"
```
...
def get_earthquakes() -> Dict[str, Any]:
    response = requests.get('https://api.terraquake.com/earthquakes/recent')
