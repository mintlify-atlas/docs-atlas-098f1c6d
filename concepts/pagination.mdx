...
curl "https://api.terraquake.com/earthquakes/recent"

# Get second page with 25 results
curl "https://api.terraquake.com/earthquakes/recent?page=2&limit=25"

# Get maximum results per page
curl "https://api.terraquake.com/earthquakes/recent?limit=100"
```

```javascript JavaScript
// Fetch first page
const response = await fetch(
  'https://api.terraquake.com/earthquakes/recent?page=1&limit=50'
);
...
response = requests.get(
    'https://api.terraquake.com/earthquakes/recent',
...
async function fetchAllEarthquakes() {
  ...
  while (hasMore) {
    const response = await fetch(
      `https://api.terraquake.com/earthquakes/recent?page=${page}&limit=100`
    );
    const data = await response.json();
...
func fetchAllEarthquakes() ([]interface{}, error) {
    ...
    for hasMore {
        url := fmt.Sprintf(
            "https://api.terraquake.com/earthquakes/recent?page=%d&limit=100",
            page,
        )
...
curl "https://api.terraquake.com/earthquakes/region?region=italy&page=2&limit=50"

# Paginate through high-magnitude earthquakes
curl "https://api.terraquake.com/earthquakes/magnitude?mag=5.0&page=1&limit=25"

# Paginate through earthquakes in a date range
curl "https://api.terraquake.com/earthquakes/date-range?startdate=2026-01-01&enddate=2026-03-03&page=3&limit=100"
```
...
const response = await fetch(
  'https://api.terraquake.com/earthquakes/recent?page=100'
);
const data = await response.json();
