...
<Tabs>
  <Tab title="Today's Events">
    ...
    ```bash cURL
    curl https://api.terraquake.com/api/v1/earthquakes/today
    ```

    ```python Python
    import requests

    response = requests.get('https://api.terraquake.com/api/v1/earthquakes/today')
    earthquakes = response.json()
    print(f"Found {earthquakes['totalEarthquakes']} events today")
    ```

    ```javascript JavaScript
    const response = await fetch('https://api.terraquake.com/api/v1/earthquakes/today');
  ...
  <Tab title="Recent Events">
    ...
    ```bash cURL
    curl https://api.terraquake.com/api/v1/earthquakes/recent
    ```

    ```python Python
    import requests

    response = requests.get('https://api.terraquake.com/api/v1/earthquakes/recent')
    data = response.json()
    ...
    ```javascript JavaScript
    const response = await fetch('https://api.terraquake.com/api/v1/earthquakes/recent');
    const data = await response.json();
  ...
  <Tab title="Last Week">
    ...
    ```bash cURL
    curl https://api.terraquake.com/api/v1/earthquakes/last-week
    ```

    ```python Python
    import requests

    url = 'https://api.terraquake.com/api/v1/earthquakes/last-week'
  ...
  <Tab title="Specific Month">
    ...
    ```bash cURL
    curl "https://api.terraquake.com/api/v1/earthquakes/month?year=2024&month=3"
    ```

    ```python Python
    import requests

    url = 'https://api.terraquake.com/api/v1/earthquakes/month'
    params = {
        'year': 2024,
        'month': 3,
        'limit': 50
    ...
    ```javascript JavaScript
    const url = new URL('https://api.terraquake.com/api/v1/earthquakes/month');
  ...
  <Tab title="Date Range">
    ...
    ```bash cURL
    curl "https://api.terraquake.com/api/v1/earthquakes/range?startdate=2024-01-01&enddate=2024-03-31"
    ```

    ```python Python
    import requests

    url = 'https://api.terraquake.com/api/v1/earthquakes/range'
    params = {
...
```bash cURL
curl "https://api.terraquake.com/api/v1/earthquakes/magnitude?mag=4.0"
```
...
url = 'https://api.terraquake.com/api/v1/earthquakes/magnitude'
...
```javascript JavaScript
const url = new URL('https://api.terraquake.com/api/v1/earthquakes/magnitude');
...
```bash cURL
curl "https://api.terraquake.com/api/v1/earthquakes/depth?depth=10"
```
...
url = 'https://api.terraquake.com/api/v1/earthquakes/depth'
params = {
    'depth': 10,
    'limit': 50,
    'sort': '-depth'
...
const response = await fetch(
  'https://api.terraquake.com/api/v1/earthquakes/depth?depth=0&sort=depth'
);
const data = await response.json();
...
```bash cURL
curl "https://api.terraquake.com/api/v1/earthquakes/region?region=Calabria"
```
...
url = 'https://api.terraquake.com/api/v1/earthquakes/region'
params = {
    'region': 'Sicilia',
    'limit': 100
}
...
for (const region of regions) {
  const url = `https://api.terraquake.com/api/v1/earthquakes/region?region=${region}`;
  const response = await fetch(url);
  const data = await response.json();
...
<Steps>
  ...
  <Step title="Build the query">
    ...
    ```javascript JavaScript
    const url = new URL('https://api.terraquake.com/api/v1/earthquakes/range');
...
url = 'https://api.terraquake.com/api/v1/earthquakes/recent'
params = {'limit': 500}
