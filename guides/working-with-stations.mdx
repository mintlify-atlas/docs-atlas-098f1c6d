...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations?limit=50&page=1"
```

```python Python
import requests

url = 'https://api.terraquake.com/api/v1/stations'
params = {
    'limit': 100,
    'page': 1
}
...
const url = new URL('https://api.terraquake.com/api/v1/stations');
...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations/code?code=ACATE"
```

```python Python
import requests

url = 'https://api.terraquake.com/api/v1/stations/code'
...
const url = `https://api.terraquake.com/api/v1/stations/code?code=${stationCode}`;
...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations/geojson?limit=500"
```
...
url = 'https://api.terraquake.com/api/v1/stations/geojson'
params = {'limit': 500}
...
```javascript JavaScript
// Fetch GeoJSON data
const response = await fetch('https://api.terraquake.com/api/v1/stations/geojson?limit=500');
const data = await response.json();
...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations/status/open"
```

```python Python
import requests

url = 'https://api.terraquake.com/api/v1/stations/status/open'
params = {'limit': 200}
...
```javascript JavaScript
const response = await fetch('https://api.terraquake.com/api/v1/stations/status/open');
const data = await response.json();
...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations/status/closed"
```

```python Python
import requests

url = 'https://api.terraquake.com/api/v1/stations/status/closed'
params = {'limit': 200}
...
```bash cURL
curl "https://api.terraquake.com/api/v1/stations/statistics"
```

```python Python
import requests

url = 'https://api.terraquake.com/api/v1/stations/statistics'
...
```javascript JavaScript
const response = await fetch('https://api.terraquake.com/api/v1/stations/statistics');
const data = await response.json();
...
class NetworkMonitor:
    def __init__(self):
        self.base_url = 'https://api.terraquake.com/api/v1'
