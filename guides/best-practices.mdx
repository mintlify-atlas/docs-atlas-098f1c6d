...
response = requests.get(
    'https://api.terraquake.com/api/v1/earthquakes/range',
...
for i in range(100):
    response = client.get('https://api.terraquake.com/api/v1/earthquakes/today')
...
try:
    data = fetch_with_retry(
        'https://api.terraquake.com/api/v1/earthquakes/recent',
        params={'limit': 100}
    )
...
class TerraQuakeClient:
    def __init__(self, base_url='https://api.terraquake.com/api/v1'):
