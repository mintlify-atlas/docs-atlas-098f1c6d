...
```bash cURL
curl "https://api.terraquake.com/api/v1/earthquakes/location?latitude=42.3601&longitude=13.3957&radius=50"
```
...
url = 'https://api.terraquake.com/api/v1/earthquakes/location'
params = {
...
const url = new URL('https://api.terraquake.com/api/v1/earthquakes/location');
...
<CardGroup cols={2}>
  <Card title="Filtering Earthquakes" icon="filter" href="/guides/filtering-earthquakes">
    Learn about magnitude, depth, and time filters
  </Card>
  <Card title="Working with Stations" icon="tower-broadcast" href="/guides/working-with-stations">
