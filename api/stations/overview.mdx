...
<CardGroup cols={2}>
  ...
  <Card title="GeoJSON Format" icon="map" href="/api/stations/geojson">
  ...
  <Card title="Closed Stations" icon="circle-xmark" href="/api/stations/status-closed">
...
See [Rate Limiting](/api-reference/rate-limits) for details.
